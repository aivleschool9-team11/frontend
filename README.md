...
**AIVLE Book Manager**는 도서 등록 시 마케팅 콘텐츠(요약, 광고 카피, 해시태그)와 북 커버 이미지를 수동으로 준비해야 하는 번거로움을 해소하고자 기획한 지능형 도서 관리 플랫폼입니다. 생성형 AI를 연동해 도서 정보 입력만으로 콘텐츠 생성부터 저장까지 자동화하여, 단순한 도서 기록을 넘어 사용자에게 최적화된 콘텐츠 경험을 제공합니다.


📋 **프로젝트 문서**: https://www.notion.so/4-368830fac55f8042af32c8b0be19e2f0?source=copy_link
